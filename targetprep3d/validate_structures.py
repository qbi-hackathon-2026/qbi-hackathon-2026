#!/usr/bin/env python3
"""Read-only auditor for targetprep3d structure choices.
...
complex whose partner is not actually an antibody) so it is CI-catchable.
    ...
    cd targetprep3d && ./.venv/bin/python validate_structures.py   # or: python validate_structures.py
"""
...
_SESSION.headers["User-Agent"] = "targetprep3d-validate/1.0"
